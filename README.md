...
The page follows the information-first structure used by recent ICICS websites:
About, Important Dates, Call for Papers and Posters, Submission, Proceedings,
Registration, Program and Keynotes, Organization, Venue and Travel, and Contact.
Conference details that have not been confirmed are clearly marked as
"To be announced".
...
If the published site uses a URL other than `https://icics2027.github.io/ICICS-bot/`,
